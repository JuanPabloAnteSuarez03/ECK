...
export const translations = {
  en: {
    ...
    "walkIn.closedToday": "Closed today",
    "walkIn.upcomingHeading": "Upcoming Walk-In",
    "walkIn.nextDate": "Next Date",
    "walkIn.hoursLabel": "Hours",
    "walkIn.regularHours": "Regular Hours",
    "walkIn.weekly.title": "Weekly Schedule",
    "walkIn.weekly.help": "Set the recurring hours for each day of the week. Toggle a day off to mark it as closed by default.",
    "walkIn.overrides.title": "Date Overrides",
    "walkIn.overrides.help": "Use these for special hours, holidays, or to close a day that's normally open. Leave intervals empty to mark a day as closed.",
    "walkIn.dayOpen": "Open",
    "walkIn.dayClosed": "Closed",
    ...
    "pricing.sprint.name": "Go-Karts Rentals",
    "pricing.sprint.duration": "10 Minutes + tax",
    ...
    "pricing.gp.name": "Mini Grand Prix",
    "pricing.gp.duration": "20 Minutes",
    "pricing.gp.main": "The Ultimate Racing Event",
    "pricing.gp.f1": "Minimum 8 People Required",
    "pricing.gp.f2": "15 Min Practice/Qualifying + 15 Min Feature Race",
    "pricing.gp.f3": "F1 Style Starts & Electronic Timing",
    "pricing.gp.f4": "Trophies Available (Minimum age 16)",
  ...
  fr: {
    ...
    "walkIn.open": "OUVERT",
    "walkIn.closed": "FERMÉ",
    "walkIn.closedToday": "Fermé aujourd'hui",
    "walkIn.upcomingHeading": "Prochain accès libre",
    "walkIn.nextDate": "Prochaine date",
    "walkIn.hoursLabel": "Heures",
    "walkIn.regularHours": "Horaire régulier",
    "walkIn.weekly.title": "Horaire hebdomadaire",
    "walkIn.weekly.help": "Définissez les heures récurrentes pour chaque jour de la semaine. Désactivez un jour pour le marquer comme fermé par défaut.",
    "walkIn.overrides.title": "Exceptions par date",
    "walkIn.overrides.help": "Utilisez ces dates pour des heures spéciales, jours fériés, ou pour fermer un jour normalement ouvert. Laissez les intervalles vides pour fermer.",
    "walkIn.dayOpen": "Ouvert",
    "walkIn.dayClosed": "Fermé",
